...
class TravelingSalesmanTests(unittest.TestCase):
    ...
    def solve(self, idToLocationLookup, optimalSequence):
        ...
        best = genetic.get_best(get_fitness=fnGetFitness, targetLen=None, optimalFitness=optimalFitness, geneSet=None,
                                display=fnDisplay, custom_mutate=fnMutate, custom_create=fnCreate, maxAge=500,
